  ...
  return (
    <div className="flex">
      <div className="bg-slate-300 flex-[1]">
        <aside className="flex flex-col justify-center items-center p-20  text-neutral-content">
      ...
      <div className="bg-neutral flex-1">
        <nav className="flex flex-col justify-center items-center p-20  text-neutral-content">
